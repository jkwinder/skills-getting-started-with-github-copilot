...
activities = {
    ...
    "Music Band": {
        ...
        "max_participants": 25,
        "participants": ["lucas@mergington.edu", "grace@mergington.edu", "ryan@mergington.edu"]
    },
    "Debate Club": {
    ...
    "Robotics Club": {
        "description": "Build and program robots for competitions and innovation challenges",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["ethan@mergington.edu", "mia@mergington.edu", "liam@mergington.edu"]
    }
}
